"""
Django settings for testapps_3 project.
...
WSGI_APPLICATION = 'testapps_3.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "testapps_3 API",
    "DESCRIPTION": "API documentation for testapps_3 App",
    "VERSION": "v1",
}
